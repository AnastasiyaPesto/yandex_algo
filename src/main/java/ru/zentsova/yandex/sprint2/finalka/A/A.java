...
-- ВРЕМЕННАЯ СЛОЖНОСТЬ --
Добавление и извлечение с обоих сторон очереди = O(1), потому что известны head и tail

-- ПРОСТРАНСТВЕННАЯ СЛОЖНОСТЬ --
O(n) так как за основу взят массив, под который при инициализации выделяется зарезервированное количество памяти
 */
